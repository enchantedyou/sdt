...
public interface LnaRepaymentScheduleMapper {
    int deleteByPrimaryKey(@Param("loanNo") String loanNo, @Param("periodNo") Long periodNo, @Param("subPeriodNo") Long subPeriodNo, @Param("orgId") String orgId);

    int insert(LnaRepaymentSchedule record);

    int insertSelective(LnaRepaymentSchedule record);

    LnaRepaymentSchedule selectByPrimaryKey(@Param("loanNo") String loanNo, @Param("periodNo") Long periodNo, @Param("subPeriodNo") Long subPeriodNo, @Param("orgId") String orgId);
    ...
    /** 全量查询还款计划 **/
    List<LnaRepaymentSchedule> selectAll_odb1();
}