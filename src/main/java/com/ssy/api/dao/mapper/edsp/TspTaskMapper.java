...
public interface TspTaskMapper {
	int deleteByPrimaryKey(@Param("subSystemCode") String subSystemCode, @Param("taskNum") String taskNum,
	...
	TspTask selectByPrimaryKey(@Param("subSystemCode") String subSystemCode, @Param("taskNum") String taskNum,
			@Param("systemCode") String systemCode, @Param("corporateCode") String corporateCode);
	...
	@EnableNotNull
	TspTask selectOneByTrxnDate(@Param("transactionDate") String transactionDate, boolean nullException);

	@EnableNotNull
	TspTask selectOneByTaskNum(@Param("taskNum") String taskNum, boolean nullException);
}