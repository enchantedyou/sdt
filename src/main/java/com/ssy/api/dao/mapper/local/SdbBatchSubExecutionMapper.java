...
public interface SdbBatchSubExecutionMapper {
    int deleteByPrimaryKey(@Param("trxnSeq") String trxnSeq, @Param("systemCode") String systemCode, @Param("flowStepId") String flowStepId);

    int insert(SdbBatchSubExecution record);

    int insertSelective(SdbBatchSubExecution record);

    SdbBatchSubExecution selectByPrimaryKey(@Param("trxnSeq") String trxnSeq, @Param("systemCode") String systemCode, @Param("flowStepId") String flowStepId);
    ...
    List<SdbBatchSubExecution> selectAll_odb1(@Param("trxnSeq") String trxnSeq, @Param("flowStepId") String flowStepId);
}