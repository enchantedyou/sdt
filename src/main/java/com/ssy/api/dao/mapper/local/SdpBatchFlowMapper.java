...
public interface SdpBatchFlowMapper {
    int deleteByPrimaryKey(@Param("systemCode") String systemCode, @Param("subSystemCode") String subSystemCode, @Param("flowGroup") String flowGroup);
    ...
    @EnableNotNull
    SdpBatchFlow selectByPrimaryKey(@Param("systemCode") String systemCode, @Param("subSystemCode") String subSystemCode, @Param("flowGroup") String flowGroup, boolean nullException);
    ...
    List<SdpBatchFlow> selectAll_odb1(@Param("flowGroup") String flowGroup, boolean nullException);
}