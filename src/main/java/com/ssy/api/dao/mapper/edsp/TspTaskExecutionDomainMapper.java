...
public interface TspTaskExecutionDomainMapper {
	int deleteByPrimaryKey(@Param("systemCode") String systemCode, @Param("corporateCode") String corporateCode,
			@Param("tranExecutionDomainCode") String tranExecutionDomainCode);
	...
	@EnableNotNull
	TspTaskExecutionDomain selectByPrimaryKey(@Param("systemCode") String systemCode,
			@Param("corporateCode") String corporateCode,
			@Param("tranExecutionDomainCode") String tranExecutionDomainCode, boolean nullException);
	...
	/** 根据法人代码和批量任务执行域查询 **/
	@EnableNotNull
	TspTaskExecutionDomain selectOne(@Param("corporateCode") String corporateCode,
			@Param("tranExecutionDomainCode") String tranExecutionDomainCode, boolean nullException);
