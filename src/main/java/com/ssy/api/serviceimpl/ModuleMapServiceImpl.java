...
public class ModuleMapServiceImpl implements ModuleMapService {
    ...
    public List<SdpModuleMapping> queryMergeModuleList() {
        return moduleMappingMapper.selectAll_odb1();
    }

    @Override
    public List<SdpModuleMapping> queryAllModuleList() {
        return moduleMappingMapper.selectAll_odb2();
    }

    @Override
    public String getServiceCode(String innerServiceCode) {
        BizUtil.fieldNotNull(innerServiceCode, SdtDict.A.inner_service_code.getId(), SdtDict.A.inner_service_code.getLongName());
