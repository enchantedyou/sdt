    ...
    public static void editDataSource(SdDatasourceEdit datasourceEdit){
        ...
        if(datasourceEdit.getDataOperateType() == E_DATAOPERATE.A){
            if(CommUtil.isNotNull(dataSource)){
                throw ApPubErr.E0006(SdtTable.A.sdp_datasource.getLongName(), SdtBusiUtil.parseStrArrayToSingle(dataSource.getDatasourceId(), dataSource.getDatasourceType()));
            }else{
            ...
            if(CommUtil.isNull(dataSource)){
                throw SdtServError.E0003(SdtTable.A.sdp_datasource.getLongName(), datasourceEdit.getDatasourceId(), datasourceEdit.getDatasourceType());
            }else{
